...
const CALL_HREF = `tel:${config.phoneNumber}`;
    ...
    <div className="mv-page" dir="rtl" lang="ar">
      <header className="mv-header">
        <div className="wrap">
          <div className="brand">
            <img
              src="/logos/mountain-view-logo.webp"
          ...
          <div className="header-actions">
            <a className="btn btn-ghost" href="#units">
              الوحدات والأسعار
            </a>
      ...
      <section className="hero" id="hero">
        ...
        <div className="hero-inner wrap">
          ...
          <div className="hero-ctas">
            ...
            <a className="btn btn-wa" href={waHref(WA.details)} target="_blank" rel="noopener noreferrer">
              <WhatsAppIcon />
              كلمنا واتساب
            </a>
      ...
      <section className="s units" id="units">
        <div className="wrap">
          ...
          <div className="unit-cards">
            {UNITS.map((u) => (
              <article key={u.name} className={`unit-card${u.limited ? " crown" : ""}`}>
      ...
      <footer className="mv-footer">
        <div className="wrap">
          <p className="broker-disclosure-footer" role="note">
          ...
          <p>
            هذه الصفحة ليست الموقع الرسمي لماونتن ڤيو.
      ...
      <a className="float-wa" href={waHref(WA.inquiry)} target="_blank" rel="noopener noreferrer" aria-label="واتساب">
      ...
      <nav className="sticky-mobile" aria-label="تواصل سريع">
        <div className="row">
          ...
          <a className="wa" href={waHref(WA.inquiry)} target="_blank" rel="noopener noreferrer">
            <WhatsAppIcon size={16} />
            واتساب
          </a>
          <a className="form" href="#lead">
            استمارة
          </a>
        </div>
      </nav>
