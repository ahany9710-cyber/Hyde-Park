    ...
    <section id="villas" className="w-full px-4 sm:px-6 lg:px-8 pt-12 md:pt-16 pb-8 md:pb-12 lg:pb-20">
      <div className="container mx-auto">
        <div className="text-center mb-6 md:mb-12">
          <p className="text-sm tracking-[0.18em] uppercase text-lavista-sand-deep font-lavista mb-2">Villa Collection</p>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                      ...
                      <div className="flex flex-col justify-center order-2 md:order-2">
                        ...
                        <h3 className="font-lavista text-3xl sm:text-4xl text-gray-900 mb-2 mt-2">
                          {currentListing.name}
                        </h3>
